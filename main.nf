...
params.bcell_method = 'Bepipred-1.0'
params.bcell_threshold = 0.5
params.bcell_length = 9
...
include { screenEpitopeAllergenToxic as screen1EpitopeAllergenToxic } from './modules/evaluateVaccine.nf'
include { screenEpitopeAllergenToxic as screen2EpitopeAllergenToxic } from './modules/evaluateVaccine.nf'
...
workflow {
    ...
    screen1EpitopeAllergenToxic(first_bcell.bcell_epitopes, first_tcell_i.tcell_i_epitopes, first_tcell_ii.tcell_ii_epitopes, 'accession1')
    screen2EpitopeAllergenToxic(second_bcell.bcell_epitopes, second_tcell_i.tcell_i_epitopes, second_tcell_ii.tcell_ii_epitopes, 'accession2')

    first_combined = combine1Epitopes(first_bcell.bcell_epitopes, first_tcell_i.tcell_i_epitopes, first_tcell_ii.tcell_ii_epitopes, 'accession1')
    second_combined = combine2Epitopes(second_bcell.bcell_epitopes, second_tcell_i.tcell_i_epitopes, second_tcell_ii.tcell_ii_epitopes, 'accession2')
