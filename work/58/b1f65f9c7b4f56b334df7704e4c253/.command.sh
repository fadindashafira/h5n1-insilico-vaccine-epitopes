...
head -n 1 hemagglutinin_combined_epitopes.csv > combined_epitopes_all.csv
for f in hemagglutinin_combined_epitopes.csv neuraminidase_combined_epitopes.csv; do
